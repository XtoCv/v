...
if tonumber(data.sender_id_user_id) == tonumber(ramsesadd[1]) or tonumber(ramsesadd[2]) == tonumber(data.sender_id_user_id) then
local inget = Redis:get(TheMero..'hmsabots'..ramsesadd[3]..data.sender_id_user_id)
...
local reply_markup = {inline_keyboard={{{text = 'لرؤية الهمسة', callback_data = '/Hmsa1@'..data.sender_id_user_id..'@'..UserId_Info.id..'/'..idnum}}}}	
...
Redis:set(TheMero..'hmsabots'..idnum..data.sender_id_user_id,username[1])
end
end
end
...
if tonumber(data.message.sender_id_user_id) == tonumber(TheMero) then
return false
end
...
if msg.sender_id.luatele == "messagesender_idChat" then
if Redis:sismember(TheMero.."Mero:SilentGroup:Group"..msg_chat_id,msg.sender_id.chat_id) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if Redis:get(TheMero.."Mero:Lock:sender_idChat"..msg_chat_id) then
...
local sender_id_name = bot.getUser(anubis[1]).first_name
local to_name = bot.getUser(to_id).first_name
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'لرؤية الهمسة', data = "sender_id:"..anubis[1].."to:"..to_id.."hmsa:"..anubis[2]
}
},
}
}
send(chat_id,msg_id,"⇜ ياحلو 「 ["..to_name.."](tg://user?id="..to_id..") 」\n⇜ لديك همسة سرية من「 ["..sender_id_name.."](tg://user?id="..anubis[1]..") 」\n⇜ انت فقط من يستطيع رؤيتها","md",true,false,false,false,reply_markup)
...
if Text and Text:match("sender_id:(.*)to:(.*)hmsa:(.*)") then
local anubis = {Text:match("sender_id:(.*)to:(.*)hmsa:(.*)")}
...
if tonumber(data.sender_id_user_id) == tonumber(UserId) then
...
data = {
{
{text = 'توب الفلوس', data = data.sender_id_user_id..'/topmon'},{text = 'توب الحراميه', data = data.sender_id_user_id..'/topzrf'},
},
{
{text = 'توب المتزوجين', data = data.sender_id_user_id..'/zoztee'}, {text = 'توب المتبرعين', data = data.sender_id_user_id..'/motbra'},
},
{
{text = 'توب النوادي', data = data.sender_id_user_id..'/topnade'},{text = 'توب المزارع', data = data.sender_id_user_id..'/mazratee'},
},
{
{text = 'اخفاء', data = data.sender_id_user_id..'/delAmr'}, 
},
{
{text = 'Louis', url="t.me/Y88F8"},
},
...
data = {
{
{text = '• رجوع •', data = data.sender_id_user_id..'/toptop'}, 
},
{
{text = 'Louis',url="t.me/Y88F8"}, 
},
...
if tonumber(data.sender_id_user_id) == tonumber(UserId) then
  local F_Name = bot.getUser(data.sender_id_user_id).first_name
Redis:set(TheMero..data.sender_id_user_id.."first_name:", F_Name)
local ban = bot.getUser(data.sender_id_user_id)
...
ballancee = Redis:get(TheMero.."tabbroat"..data.sender_id_user_id) or 0
...
zrfee = Redis:get(TheMero.."rrfff"..data.sender_id_user_id) or 0
...
ballancee = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
...
if tonumber(data.sender_id_user_id) == tonumber(UserId) then
doltebank = "🇸🇾"
Redis:set(TheMero.."doltebank"..data.sender_id_user_id,doltebank)
cccall = Redis:get(TheMero.."boobb"..data.sender_id_user_id)
ccctype = Redis:get(TheMero.."bbobb"..data.sender_id_user_id)
shakse = Redis:get(TheMero.."shkse"..data.sender_id_user_id)
if shakse == "طيبة" then
shakseshakse = "طيبة 😇"
else
shakseshakse = "شريرة 😈"
...
if tonumber(data.sender_id_user_id) == tonumber(UserId) then
shakse = "طيبة"
Redis:set(TheMero.."shkse"..data.sender_id_user_id,shakse)
ttshakse = '⇜ اختر دولتك'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '🇸🇾', data = data.sender_id_user_id..'/syria'},{text = '🇸🇦', data = data.sender_id_user_id..'/sudia'},{text = '🇮🇶', data = data.sender_id_user_id..'/iraqq'},
},{
{text = '🇾🇪', data = data.sender_id_user_id..'/yemen'},{text = '🇹🇳', data = data.sender_id_user_id..'/tunsia'},{text = '🇶🇦', data = data.sender_id_user_id..'/qatar'},
},{
{text = '🇸🇩', data = data.sender_id_user_id..'/sudan'},{text = '🇵🇸', data = data.sender_id_user_id..'/plastin'},{text = '🇲🇦', data = data.sender_id_user_id..'/moroco'},
},{
{text = '🇴🇲', data = data.sender_id_user_id..'/oman'},{text = '🇱🇾', data = data.sender_id_user_id..'/libya'},{text = '🇰🇼', data = data.sender_id_user_id..'/kuwit'},
},{
{text = '🇱🇧', data = data.sender_id_user_id..'/lebanon'},{text = '🇯🇴', data = data.sender_id_user_id..'/jordan'},{text = '🇧🇭', data = data.sender_id_user_id..'/bahren'},
},{
{text = '🇪🇬', data = data.sender_id_user_id..'/egypt'},{text = '🇩🇿', data = data.sender_id_user_id..'/algeria'},{text = '🇦🇪', data = data.sender_id_user_id..'/emarite'},
},
{text = 'Louis',url="t.me/Y88F8"}, 
}
}
...
local banid = data.sender_id_user_id
Redis:set(TheMero.."bobna"..data.sender_id_user_id,news)
Redis:set(TheMero.."boob"..data.sender_id_user_id,balas)
Redis:set(TheMero.."boobb"..data.sender_id_user_id,creditcc)
Redis:set(TheMero.."bbobb"..data.sender_id_user_id,mast)
...
Redis:sadd(TheMero.."booob",data.sender_id_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'شخصية طيبة 😇', data = data.sender_id_user_id..'/msalm'},{text = 'شخصية شريرة 😈', data = data.sender_id_user_id..'/shrer'},
},
{text = 'Louis',url="t.me/Y88F8"}, 
}
}
...
Redis:set(TheMero.."bobna"..data.sender_id_user_id,news)
Redis:set(TheMero.."boob"..data.sender_id_user_id,balas)
Redis:set(TheMero.."boobb"..data.sender_id_user_id,creditvi)
Redis:set(TheMero.."bbobb"..data.sender_id_user_id,visssa)
...
Redis:set(TheMero.."bobna"..data.sender_id_user_id,news)
Redis:set(TheMero.."boob"..data.sender_id_user_id,balas)
Redis:set(TheMero.."boobb"..data.sender_id_user_id,creditex)
Redis:set(TheMero.."bbobb"..data.sender_id_user_id,exprs)
...
if tonumber(data.sender_id_user_id) == tonumber(UserId) then
cccall = Redis:get(TheMero.."tdbelballance"..data.sender_id_user_id) or 0
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
if tonumber(ballance) < tonumber(cccall) then
return edit(ChatId,Msg_id, "⇜ فلوسك ماتكفي","md",true)
end
Redis:setex(TheMero.."iioood" .. data.sender_id_user_id,920, true)
local list = {"1", "2", "3"}
local rand = list[math.random(#list)]
if rand == "1" then -- 1 con
cccallcc = tonumber(ballance) + tonumber(cccall)
Redis:set(TheMero.."boob"..data.sender_id_user_id,cccallcc)
Redis:del(TheMero.."tdbelballance"..data.sender_id_user_id)
...
cccallcc = tonumber(ballance) - tonumber(cccall)
Redis:set(TheMero.."boob"..data.sender_id_user_id,cccallcc)
cccall = Redis:get(TheMero.."tdbelballance"..data.sender_id_user_id)
Redis:del(TheMero.."tdbelballance"..data.sender_id_user_id)
local convert_mony = string.format("%.0f",cccall)
local convert_monyy = string.format("%.0f",cccallcc)
msalm = "⌯ خسرت بالسحب ☹️\n\n⇜ المبلغ : "..convert_mony.."\nرصيدك الان : `"..convert_monyy.."`\n✧"
...
Redis:set(TheMero.."boob"..data.sender_id_user_id,cccallcc)
namefram = Redis:get(TheMero.."namefram"..data.sender_id_user_id)
Redis:sadd(TheMero.."farmarname", namefram)
Redis:set(TheMero.."sizefram"..data.sender_id_user_id,50000)
Redis:sadd(TheMero.."ownerfram",data.sender_id_user_id)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
...
namefram = Redis:get(TheMero.."namefram"..data.sender_id_user_id)
Redis:sadd(TheMero.."farmarname", namefram)
Redis:set(TheMero.."sizefram"..data.sender_id_user_id,100000)
Redis:sadd(TheMero.."ownerfram",data.sender_id_user_id)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 8×8\n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(TheMero.."namefram"..data.sender_id_user_id)
Redis:sadd(TheMero.."farmarname", namefram)
Redis:set(TheMero.."sizefram"..data.sender_id_user_id,200000)
Redis:sadd(TheMero.."ownerfram",data.sender_id_user_id)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 12×12\n⇜ السعر : 1000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(TheMero.."namefram"..data.sender_id_user_id)
Redis:sadd(TheMero.."farmarname", namefram)
Redis:set(TheMero.."sizefram"..data.sender_id_user_id,300000)
Redis:sadd(TheMero.."ownerfram",data.sender_id_user_id)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 16×16\n⇜ السعر : 5000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(TheMero.."namefram"..data.sender_id_user_id)
Redis:sadd(TheMero.."farmarname", namefram)
Redis:set(TheMero.."sizefram"..data.sender_id_user_id,400000)
Redis:sadd(TheMero.."ownerfram",data.sender_id_user_id)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 32×32\n⇜ السعر : 10000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
if Redis:get(TheMero.."mrkzplayer".."1"..data.sender_id_user_id) then
...
mrkzplayer = "مهاجم"
cityplayer = "🇺🇦 اوكرانيا"
Redis:set(TheMero.."nameplayer".."1"..data.sender_id_user_id,nameplayer)
Redis:set(TheMero.."energyplayer".."1"..data.sender_id_user_id,energyplayer)
Redis:set(TheMero.."mrkzplayer".."1"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."1"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."1"..data.sender_id_user_id,39000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(TheMero.."mrkzplayer".."4"..data.sender_id_user_id) then
...
mrkzplayer = "مدافع"
cityplayer = "البرازيل 🇧🇷"
Redis:set(TheMero.."nameplayer".."4"..data.sender_id_user_id,nameplayer)
Redis:set(TheMero.."energyplayer".."4"..data.sender_id_user_id,energyplayer)
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,50000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(TheMero.."mrkzplayer".."3"..data.sender_id_user_id) then
...
Redis:set(TheMero.."nameplayer".."3"..data.sender_id_user_id,nameplayer)
Redis:set(TheMero.."energyplayer".."3"..data.sender_id_user_id,energyplayer)
Redis:set(TheMero.."mrkzplayer".."3"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."3"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."3"..data.sender_id_user_id,70000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,40000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."3"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."3"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."3"..data.sender_id_user_id,20000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : خوان ماتا\n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إسبانيا 🇪🇸 \n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,15000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."1"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."1"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."1"..data.sender_id_user_id,100000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,20000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,30000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(TheMero.."mrkzplayer".."5"..data.sender_id_user_id) then
...
mrkzplayer = "حارس"
cityplayer = "ألمانيا 🇩🇪 "
Redis:set(TheMero.."nameplayer".."5"..data.sender_id_user_id,nameplayer)
Redis:set(TheMero.."energyplayer".."5"..data.sender_id_user_id,energyplayer)
Redis:set(TheMero.."mrkzplayer".."5"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."5"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."5"..data.sender_id_user_id,110000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : تير شتيجن\n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : ألمانيا 🇩🇪 \n⇜ السعر : 110000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(TheMero.."mrkzplayer".."2"..data.sender_id_user_id) then
...
mrkzplayer = "جناح"
cityplayer = "فرنسا 🇫🇷 "
Redis:set(TheMero.."nameplayer".."2"..data.sender_id_user_id,nameplayer)
Redis:set(TheMero.."energyplayer".."2"..data.sender_id_user_id,energyplayer)
Redis:set(TheMero.."mrkzplayer".."2"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."2"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."2"..data.sender_id_user_id,45000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."2"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."2"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."2"..data.sender_id_user_id,78000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : رودريغو\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,65000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ميليتاو\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 65000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,73000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : الابا\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : النمسا 🇦🇹 \n⇜ السعر : 73000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."2"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."2"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."2"..data.sender_id_user_id,180000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فينيسيوس \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 94\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 180000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."2"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."2"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."2"..data.sender_id_user_id,55000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دي ماريا \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 85\n⇜ الجنسية : الأرجنتين 🇦🇷 \n⇜ السعر : 55000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,38000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دانييلي \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 38000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."1"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."1"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."1"..data.sender_id_user_id,55000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."5"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."5"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."5"..data.sender_id_user_id,99000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دوناروما \n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 89\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 99000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,55000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."2"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."2"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."2"..data.sender_id_user_id,59000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."4"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."4"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."4"..data.sender_id_user_id,170000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ايدن ازارد \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 93\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 170000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."1"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."1"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."1"..data.sender_id_user_id,60000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فرمينو \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 86\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 60000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."1"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."1"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."1"..data.sender_id_user_id,19000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : جاك كلارك \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إنجلترا 🏴󠁧󠁢󠁥󠁮󠁧󠁿 \n⇜ السعر : 19000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."1"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."1"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."1"..data.sender_id_user_id,53000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."1"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."1"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."1"..data.sender_id_user_id,41000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : توريس \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 41000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."3"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."3"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."3"..data.sender_id_user_id,41000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."3"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."3"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."3"..data.sender_id_user_id,74000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."3"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."3"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."3"..data.sender_id_user_id,78000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : بول بوجبا \n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : فرنسا 🇫🇷 \n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."3"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."3"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."3"..data.sender_id_user_id,90000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."5"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."5"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."5"..data.sender_id_user_id,80000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."5"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."5"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."5"..data.sender_id_user_id,70000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."5"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."5"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."5"..data.sender_id_user_id,52000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."5"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."5"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."5"..data.sender_id_user_id,20000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."5"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."5"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."5"..data.sender_id_user_id,40000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."1"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."1"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."1"..data.sender_id_user_id,20000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."mrkzplayer".."2"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."2"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."2"..data.sender_id_user_id,100000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : محمد صلاح\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : مصر 🇪🇬 \n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."2"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."2"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."2"..data.sender_id_user_id,90000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : نيمار\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 90\n⇜ الجنسية : السنغال 🇸🇳 \n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."mrkzplayer".."2"..data.sender_id_user_id,mrkzplayer)
Redis:set(TheMero.."cityplayer".."2"..data.sender_id_user_id,cityplayer)
Redis:set(TheMero.."priceplayer".."2"..data.sender_id_user_id,80000)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."boob"..data.sender_id_user_id,cccallcc)
lkbnade = Redis:get(TheMero.."lkbnade"..data.sender_id_user_id)
Redis:sadd(TheMero.."lkbnadesadd", lkbnade)
namenade = "ريال مدريد"
Redis:set(TheMero.."namenade"..data.sender_id_user_id,namenade)
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,50)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,45)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : برشلونة\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 150000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,40)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : تشيلسي\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,35)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,30)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ليفربول\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 120000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,25)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,20)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,15)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : يوفنتوس\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 40000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheMero.."nokatnade"..data.sender_id_user_id,0)
Redis:sadd(TheMero.."ownernade",data.sender_id_user_id)
Redis:set(TheMero.."energynade"..data.sender_id_user_id,10)
ballance = Redis:get(TheMero.."boob"..data.sender_id_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ارسنال\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
